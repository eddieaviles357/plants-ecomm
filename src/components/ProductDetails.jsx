...
const ProductDetails = ({ products }) => {
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 gap-y-6">
          <div className="group">
            <div className="relative overflow-hidden border border-gray-3 flex items-center justify-center rounded-xl bg-white min-h-[270px] mb-4">
              <a href="products/apple-imac-m1-24-inch-2025">
                <img alt="" loading="lazy" src="/_next/image?url=https%3A%2F%2Fres.cloudinary.com%2Fdc6svbdh9%2Fimage%2Fupload%2Fv1747047333%2Fproducts%2Fwxr0bhxthtz0mxispkyj.png&amp;w=640&amp;q=75" style={{color: "transparent"}} />
              </a>
              <div className="absolute top-2 right-2">
                <span className="px-2 py-1 text-xs font-medium text-white rounded-full bg-blue">40% OFF</span>
              </div>
  ...
  {/* {products.map(({id, sku, productName, productDescription, price}) => (
