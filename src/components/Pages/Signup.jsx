        ...
        <div className="max-w-[570px] w-full mx-auto rounded-2xl bg-white shadow-1 p-4 sm:p-7.5 xl:p-11">
          ...
          <div>
            <form>
                ...
                <p class="mt-6 text-sm text-center">Already have an account?<a class="pl-1 font-medium duration-200 ease-out text-dark hover:text-blue-dark" href="/login">Log in Now!</a></p>
            </form>
          </div>
        </div>
      </div>
