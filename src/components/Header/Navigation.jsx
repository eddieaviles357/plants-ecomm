...
const Navigation = () => {
  return (
    <header className="fixed left-0 bg-white top-0 w-full z-50 transition-all  ease-in-out duration-300 false">
